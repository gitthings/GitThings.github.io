...
.theme-dark {
    ...
    --background-trans: hsla(0, 0%, 100%, 0.15);
    --skeleton-bg: #2e2e2e;
    --skeleton-hl: #363636;
    --text-bright: #fff;
    --text-normal: #bebebe;
    ...
    --gradient-cover: linear-gradient(
        90deg,
        rgba(33, 33, 33, 0),
        rgba(33, 33, 33, 0.013) 8.1%,
        rgba(33, 33, 33, 0.049) 15.5%,
        rgba(33, 33, 33, 0.104) 22.5%,
        rgba(33, 33, 33, 0.175) 29%,
        rgba(33, 33, 33, 0.259) 35.3%,
        rgba(33, 33, 33, 0.352) 41.2%,
        rgba(33, 33, 33, 0.45) 47.1%,
        rgba(33, 33, 33, 0.55) 52.9%,
        rgba(33, 33, 33, 0.648) 58.8%,
        rgba(33, 33, 33, 0.741) 64.7%,
        rgba(33, 33, 33, 0.825) 71%,
        rgba(33, 33, 33, 0.896) 77.5%,
        rgba(33, 33, 33, 0.951) 84.5%,
        rgba(33, 33, 33, 0.987) 91.9%,
        var(--background-secondary)
    );
    --article-cover: linear-gradient(
        180deg,
...
.animation-text {
    ...
    -webkit-animation: SkeletonLoading 1.5s ease-in-out 0s infinite normal none running;
    animation: SkeletonLoading 1.5s ease-in-out 0s infinite normal none running;
}
.inverted-main-grid,
.main-grid {
    display: flex;
...
.post-html a {
    ...
    background-image: linear-gradient(180deg, var(--bg-sub-accent-55) 0, var(--bg-sub-accent-55));
}
.post-html a strong {
...
#search-modal .search-footer {
    ...
    user-select: none;
    width: 100%;
    box-shadow: 0 -1px 0 0, 0 -3px 6px 0 #363636 rgba(30, 35, 90, 0.12);
    z-index: 300;
}
...
html::-webkit-scrollbar-thumb {
    background: #434343;
    border-radius: 16px;
    box-shadow: inset 2px 2px 2px hsla(0, 0%, 39.2%, 0.25), inset -2px -2px 2px rgba(0, 0, 0, 0.25);
}
...
.dropdown-content-enter-active[data-v-10d047b7],
.dropdown-content-leave-active[data-v-10d047b7] {
    transition: all 0.2s;
}
.dropdown-content-enter[data-v-10d047b7],
.dropdown-content-leave-to[data-v-10d047b7] {
    opacity: 0;
    transform: translateY(-5px);
}
.toggler[data-v-60fb900e] {
    position: relative;
    width: 40px;
    height: 22px;
    background-color: var(--background-primary);
    border-radius: 24px;
    border: 3px solid rgba(61, 64, 91, 0.35);
    box-sizing: border-box;
    transition: background-color 0.25s ease;
}
.slider[data-v-60fb900e] {
    top: -6px;
    left: -6px;
    width: 28px;
    height: 28px;
    ...
    border-radius: 50%;
    transition: all 0.25s cubic-bezier(0.4, 0.03, 0, 1) 0s;
    position: absolute;
    --tw-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);
    box-shadow: var(--tw-ring-offset-shadow, 0 0 transparent), var(--tw-ring-shadow, 0 0 transparent), var(--tw-shadow);
}
.header-controls span[data-v-2a1087e7] {
    display: flex;
    justify-content: center;
    align-items: center;
    color: #fff;
...
.header-controls span[no-hover-effect][data-v-2a1087e7]:hover {
    opacity: 1;
}
.header-controls span[data-v-2a1087e7]:hover {
    opacity: 0.5;
}
.header-controls span .svg-icon[data-v-2a1087e7] {
    stroke: #fff;
    height: 2rem;
    width: 2rem;
    margin-right: 0.5rem;
...
.header-controls .search-bar[data-v-2a1087e7] {
    background-color: transparent;
    border-radius: 9999px;
    display: flex;
    flex-direction: row;
...
.header-controls .search-bar.active[data-v-2a1087e7] {
    background-color: var(--background-secondary);
    opacity: 0.95;
    width: 200px;
}
.header-controls .search-bar.active imput[data-v-2a1087e7] {
    width: auto;
}
.header-controls .search-bar[data-v-2a1087e7]:focus,
.header-controls .search-bar input[data-v-2a1087e7] {
    -webkit-appearance: none;
    -moz-appearance: none;
    appearance: none;
    outline: none;
...
.header-controls .search-bar svg[data-v-2a1087e7] {
    float: right;
}
.nav-link[data-v-292ddd56]:hover {
    color: var(--text-bright);
}
.nav-link[data-v-292ddd56]:hover:before {
    opacity: 0.6;
}
.nav-link[data-v-292ddd56]:before {
    background-color: var(--background-secondary);
    border-radius: 0.5rem;
    opacity: 0;
    position: absolute;
...
.header-container .site-header[data-v-ed8263dc] {
...
#Ob-Navigator svg[data-v-fb3641a4] {
    pointer-events: none;
    stroke: currentColor !important;
}
#Ob-Navigator .Ob-Navigator-submenu[data-v-fb3641a4] {
    list-style-type: none;
    margin: 0;
    padding: 0;
    position: absolute;
...
#Ob-Navigator .Ob-Navigator-submenu li[data-v-fb3641a4] {
    background-color: var(--background-primary);
    border-radius: 9999px;
    display: flex;
    align-items: center;
...
#Ob-Navigator .Ob-Navigator-submenu li:hover .Ob-Navigator-tips[data-v-fb3641a4] {
    opacity: 1;
    transform: translateX(-15%);
}
#Ob-Navigator .Ob-Navigator-submenu li div[data-v-fb3641a4] {
    background-color: var(--background-secondary);
    border-radius: 9999px;
    display: flex;
    align-items: center;
...
#Ob-Navigator.Ob-Navigator--open .Ob-Navigator-submenu li[data-v-fb3641a4] {
    opacity: 1;
}
#Ob-Navigator.Ob-Navigator--open .Ob-Navigator-submenu li[data-v-fb3641a4]:first-of-type {
    transform: translateX(-4.8rem);
}
#Ob-Navigator.Ob-Navigator--open .Ob-Navigator-submenu li[data-v-fb3641a4]:nth-of-type(2) {
    transform: translate(-3.6rem, -3.6rem);
}
#Ob-Navigator.Ob-Navigator--open .Ob-Navigator-submenu li[data-v-fb3641a4]:nth-of-type(3) {
    transform: translateY(-4.8rem);
}
#Ob-Navigator.Ob-Navigator--open .Ob-Navigator-submenu li[data-v-fb3641a4]:nth-of-type(4) {
    transform: translateY(-8.4rem);
}
#Ob-Navigator.Ob-Navigator--scrolling[data-v-fb3641a4] {
    transform: translateX(2.4rem);
    opacity: 0.6;
}
#Ob-Navigator .Ob-Navigator-tips[data-v-fb3641a4] {
    background-color: var(--background-secondary);
    border-radius: 0.375rem;
    font-size: 0.75rem;
    line-height: 1rem;
...
#Ob-Navigator .Ob-Navigator-ball[data-v-fb3641a4] {
    background-color: var(--background-secondary);
    padding: 0.125rem;
    position: relative;
...
#Ob-Navigator .Ob-Navigator-ball[data-v-fb3641a4],
#Ob-Navigator .Ob-Navigator-ball div[data-v-fb3641a4],
#Ob-Navigator .Ob-Navigator-btt[data-v-fb3641a4] {
    border-radius: 9999px;
    display: flex;
    align-items: center;
    justify-content: center;
...
#Ob-Navigator .Ob-Navigator-btt div[data-v-fb3641a4] {
    border-radius: 9999px;
    display: flex;
    align-items: center;
    justify-content: center;
...
.custom-social-svg-icon[data-v-78af753d] {
    width: 1em;
    height: 1em;
    font-size: 1em;
...
#Aurora-Dia--body[data-v-4ca246e5] {
    position: relative;
    display: flex;
    align-items: center;
    justify-content: center;
    ...
    --aurora-dia--linear-gradient-hover: linear-gradient(180deg, #25b0cc, #3f60de);
    --aurora-dia--platform-light: #b712ac;
}
.Aurora-Dia[data-v-4ca246e5] {
    position: absolute;
    bottom: 30px;
    ...
    -webkit-animation: breathe-and-jump-4ca246e5 3s linear infinite;
    animation: breathe-and-jump-4ca246e5 3s linear infinite;
    cursor: pointer;
    z-index: 1;
}
.Aurora-Dia[data-v-4ca246e5]:before {
    content: "";
    position: absolute;
    top: -1px;
    left: -1px;
...
.Aurora-Dia.active[data-v-4ca246e5] {
    -webkit-animation: deactivate-4ca246e5 0.75s linear, bounce-then-breathe-4ca246e5 5s linear infinite;
    animation: deactivate-4ca246e5 0.75s linear, bounce-then-breathe-4ca246e5 5s linear infinite;
}
.Aurora-Dia--eyes > .Aurora-Dia--eye[data-v-4ca246e5] {
    position: absolute;
    ...
    box-shadow: 0 0 7px hsla(0, 0%, 100%, 0.5);
    -webkit-animation: blink-4ca246e5 5s linear infinite;
    animation: blink-4ca246e5 5s linear infinite;
}
.Aurora-Dia--eyes > .Aurora-Dia--eye.left[data-v-4ca246e5] {
    left: 25%;
}
.Aurora-Dia--eyes > .Aurora-Dia--eye.right[data-v-4ca246e5] {
    right: 25%;
}
.Aurora-Dia--eyes.moving > .Aurora-Dia--eye[data-v-4ca246e5] {
    -webkit-animation: none;
    animation: none;
}
.Aurora-Dia--platform[data-v-4ca246e5] {
    position: relative;
    top: 0;
    ...
    -webkit-animation: jump-pulse-4ca246e5 3s linear infinite;
    animation: jump-pulse-4ca246e5 3s linear infinite;
    border-radius: 50%;
    transition: all 0.2s linear;
}
.Aurora-Dia[data-v-4ca246e5]:hover {
    -webkit-animation: shake-to-alert-4ca246e5 0.5s linear;
    animation: shake-to-alert-4ca246e5 0.5s linear;
    height: var(--auora-dia--hover-height);
    transform: translateY(-7px);
}
.Aurora-Dia[data-v-4ca246e5]:hover:before {
    background: var(--aurora-dia--linear-gradient-hover);
}
.Aurora-Dia:hover > .Aurora-Dia--eyes > .Aurora--Dia-eye[data-v-4ca246e5],
.Aurora-Dia[data-v-4ca246e5]:hover {
    border-color: var(--text-accent);
    box-shadow: 0 0 5px var(--text-accent);
}
.Aurora-Dia:hover + .Aurora-Dia--platform[data-v-4ca246e5] {
    box-shadow: 0 0 var(--auora-dia--platform-size) var(--text-accent), 0 0 15px var(--text-accent) inset;
    -webkit-animation: shake-pulse-4ca246e5 0.5s linear;
    animation: shake-pulse-4ca246e5 0.5s linear;
}
#Aurora-Dia--tips-wrapper[data-v-4ca246e5] {
    position: absolute;
    bottom: 80px;
    right: -120px;
    width: 200px;
    ...
    border-radius: 8px;
    opacity: 0;
    -webkit-animation: tips-breathe-4ca246e5 3s linear infinite;
    animation: tips-breathe-4ca246e5 3s linear infinite;
    transition: opacity 0.3s linear;
}
#Aurora-Dia--tips-wrapper.active[data-v-4ca246e5] {
    opacity: 0.86;
}
.Aurora-Dia--tips[data-v-4ca246e5] {
    position: relative;
    height: 100%;
    width: 100%;
    min-height: 60px;
...
.Aurora-Dia--tips > span[data-v-4ca246e5] {
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    padding: 0 0.1rem;
    color: #7aa2f7;
...
@-webkit-keyframes deactivate-4ca246e5 {
    0% {
...
@-webkit-keyframes tips-breathe-4ca246e5 {
    0%,
    to {
...
@keyframes tips-breathe-4ca246e5 {
    0%,
    to {
        transform: translateY(0);
    }
...
@-webkit-keyframes bounce-then-breathe-4ca246e5 {
    0%,
    5%,
    10%,
    15% {
...
@keyframes bounce-then-breathe-4ca246e5 {
    0%,
    5%,
    10%,
    15% {
...
@-webkit-keyframes breathe-and-jump-4ca246e5 {
    0%,
    40%,
    80%,
    to {
...
@keyframes breathe-and-jump-4ca246e5 {
    0%,
    40%,
    80%,
    to {
...
@-webkit-keyframes blink-4ca246e5 {
    0%,
    to {
...
@-webkit-keyframes jump-pulse-4ca246e5 {
    0%,
    40%,
    80%,
    to {
...
@-webkit-keyframes shake-to-alert-4ca246e5 {
    0%,
    20%,
    40%,
    60%,
...
@keyframes shake-to-alert-4ca246e5 {
    0%,
    20%,
    40%,
    60%,
...
@-webkit-keyframes shake-pulse-4ca246e5 {
    0%,
    20%,
    40%,
    60%,
...
@keyframes shake-pulse-4ca246e5 {
    0%,
    20%,
    40%,
    60%,
...
#sidebar-navigator svg[data-v-34183873] {
    pointer-events: none;
}
.toc {
    list-style: none;
...
.profile[data-v-6477376e] {
    top: -7%;
    height: 100%;
    max-height: 100%;
}
.paginator[data-v-399dec14] {
    justify-content: center;
    margin-top: 2rem;
    margin-bottom: 2rem;
}
.paginator[data-v-399dec14],
.paginator ul[data-v-399dec14] {
    display: flex;
    flex-direction: row;
}
.paginator ul li[data-v-399dec14] {
    cursor: pointer;
    display: flex;
    flex-direction: row;
    align-items: center;
...
.paginator ul li[data-v-399dec14]:hover {
    opacity: 0.5;
}
.paginator ul li svg[data-v-399dec14] {
    font-weight: 800;
    margin-left: 0.5rem;
    margin-right: 0.5rem;
    color: var(--text-accent);
}
.paginator .active[data-v-399dec14] {
    color: var(--text-accent);
}
.svg-icon[data-v-fb438624] {
    width: 1em;
    height: 1em;
    vertical-align: -0.15em;
    fill: currentColor;
...
.svg-external-icon[data-v-fb438624] {
